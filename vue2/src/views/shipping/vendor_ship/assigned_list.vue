    ...
    <el-table v-loading="loading" :data="shippingList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="商品" width="450px">
        <template slot-scope="scope">
          ...
          <div v-if="scope.row.itemList && scope.row.itemList[0]" style="float: left;display: flex;align-items: center;padding-right: 20px">
      ...
      <el-table-column label="发货状态" align="center" prop="sendStatus">
        <template slot-scope="scope">
          <el-tag v-if="scope.row.sendStatus === 0" size="small">待备货</el-tag>
          <el-tag v-if="scope.row.sendStatus === 1" size="small">待发货</el-tag>
          <el-tag v-if="scope.row.sendStatus === 2" size="small">已发货</el-tag>
        </template>
      </el-table-column>
      ...
      <el-tabs v-model="activeName">
        ...
        <el-tab-pane label="商品列表" name="orderItems" lazy>
          <el-table :data="form.itemList" style="margin-bottom: 10px;">
            ...
            <el-table-column label="商品标题" prop="goodsName" width="300" />
            ...
            <el-table-column label="平台ID" prop="skuId" />
